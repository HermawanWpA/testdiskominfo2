          ...
          <div class="col">
            {{-- <input type="number" name="id_biodata" hidden> --}}
                <div class="form-group mb-3">
                    ...
                    <input type="text" class="form-control" name="nama_wifi" placeholder="Nama Wifi" value="{{ old('nama_wifi') }}">
                </div>
            </div>
                <div class="col">
                    <div class="form-group mb-3">
            ...
            <div class="form-group">
               <label for="nama_pegawai">Lokasi</label>
                <select name="id_lokasi" required class="form-control">
